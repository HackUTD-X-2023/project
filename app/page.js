...
export default function Home() {
  ...
  return (
    ...
    <main className="bg-[url('/cover.jpg')] h-screen bg-no-repeat bg-cover relative z-10 flex flex-col justify-center">
      <div ></div>
      <div className='absolute mt-40 ml-52 px-16 py-8 bg-gray-900 w-fit rounded-3xl '>
        <div className='my-10 flex flex-col gap-y-10 items-center'>
          ...
          <button className="rounded-2xl text-xl text-white bg-sky-400 h-16 w-11/12 hover:bg-sky-600 transition duration-150 focus:ring focus:ring-sky-200 " type="button" onClick={() => router.push('/form')}>
            GET STARTED!
          </button>
        </div>
      </div>
